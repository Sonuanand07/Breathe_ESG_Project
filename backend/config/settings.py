"""
Django settings for Breathe ESG config.
"""
...
#   DB_NAME=backend/db.sqlite3   (path to sqlite file)
# PostgreSQL:
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Breathe ESG Data Ingestion API',
    'DESCRIPTION': 'API for ingesting and reviewing emissions data',
    'VERSION': '1.0.0',
    'SERVE_PERMISSIONS': [
        'rest_framework.permissions.IsAuthenticated',
    ],
